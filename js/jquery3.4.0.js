/*! jQuery v3.4.0 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
	...
	var h = function(n) {
		...
		for (e in d = se.support = {}, i = se.isXML = function(e) {
				...
				if ((e.ownerDocument || e) !== C && T(e), d.matchesSelector && E && !N[t + " "] && (!s || !s.test(t)) && (!v || !
						v.test(t))) try {
					var n = c.call(e, t);
	...
	k.fn.extend({
		...
		contents: function(e) {
			return "undefined" != typeof e.contentDocument ? e.contentDocument : (N(e, "template") && (e = e.content || e),
	...
	function ve(e, t) {
		...
		return n = "undefined" != typeof e.getElementsByTagName ? e.getElementsByTagName(t || "*") : "undefined" != typeof e
			.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && N(e, t) ? k.merge([e], n) : n
	}
			...
			handler: function(e) {
				...
				if (1 & e.isTrigger && this[i]) {
					if (r)(k.event.special[i] || {}).delegateType && e.stopPropagation();
						...
						Q.set(this, i, !1) : n = void 0, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n
	...
	k.ajaxSetup({
		...
		}, k.isArray = Array.isArray, k.parseJSON = JSON.parse, k.nodeName = N, k.isFunction = m, k.isWindow = x, k.camelCase =
